/***********************************************************************
* majority.cpp - returns the int that appears the majority of the time.
* Compile g++ majoriy.cpp -o Majority -g -Wall -std=c++0x
************************************************************************/
#include <iostream>
using std::cout;
#include <algorithm>
...
/*******************************************************************
* Function majority()
* Param: *arr - The array to be checked for majority elements.
* Param: numElem - The number of elements in the array.
* Returns: An int that represents the majority element or -1.
