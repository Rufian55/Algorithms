/*****************************************************************************
 * Recursive and Dynamic Programming implementations of Longest
 * Common Subsequence with Printing of the actual LCS.
...
int LCS_DP(char *X, char *Y, int m, int n) {
    ...
    /* Start from the right-most-bottom-most corner
	   and one by one memoize characters in lcs[]  */
    i = m;
    j = n;
    while (i > 0 && j > 0) {
