/******************************************************************************
* fractionalKnapSack.cpp - returns fractional Knapsack Solution.
...
// Struct for Item - stores weight and corresponding value of Item.
struct Item {
    int value, weight;
    // Constructor
...
// Comparitor function to sort Item according to value/weight ratio.
bool cmp(struct Item a, struct Item b){
...
// Greedy method to solve fractional knapsack.
double fractionalKnapsack(int capacity, struct Item arr[], int n) {
